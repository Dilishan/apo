...
$(function() {
    var availableTags = <?php include('autofill/autocomplete_p_title.php'); ?>;
    $("#tag").autocomplete({
...
<form name="pro_search" class="form" action="pro_wise.php" method="post">

	 <div class="header">
    <center><h1>Enter a Project Title</h1></center>
    </div>
	...
	<table>
	<tr>
	<td><div class="sbox"><input type="text" class="input" name="pt" id="tag" size="40" required></div></td>
	</tr>
	</table>
