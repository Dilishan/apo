...
<caption><h1 style="color:white;">Project Details - <?php echo $_POST['pers'] ; ?> </h1></caption>
<thead>
...
$result=mysql_query("SELECT * FROM project_details RIGHT JOIN nom_rec_c ON project_details.pro_id=nom_rec_c.pro_id RIGHT JOIN ticketing ON nom_rec_c.pro_id=ticketing.pro_id WHERE nom_rec_c.name='$_POST[pers]' GROUP BY project_details.pro_id ORDER BY project_details.pro_id ASC");
