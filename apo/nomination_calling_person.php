...
if(isset($_GET["nomination_calling_person"])){
...
$s2="INSERT INTO `person`(`pro_id`, `pers_id`, `title`, `pers_name`, `designation`, `cname`) VALUES ('$_POST[fln]','','$_POST[ti]','$_POST[fn]','$_POST[des]','$_POST[cn]')";
...
$a2=mysql_query($s2,$r);
 ...
 echo "<script>alert('Done');window.location='nomination_calling_person.php';</script>";
...
<form name="nomination_calling_person" class="form" action="?nomination_calling_person" method="post">

    <div class="header">
    <h1>Nomination Calling - <div id="b1"><input type ="radio" name = "nom" value = "person" checked="checked" id="p">Person<br> 
<input type ="radio" name = "nom" value = "organization" id="o">Organization</div></h1>
	</div>
...
<tr>
<td align = "left" width="27%">Designation</td>
<td><input type="text" name="des"  class="input" size="40" placeholder="" required></td>
</tr>

<tr>
<td align = "left">Organization</td>
<td><input type="text" name="cn" class="input" size="40" placeholder="Ex: National Productivity" required></td>
</tr>
