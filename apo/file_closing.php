...
$s1="INSERT INTO `file_closing`(`pro_id`, `f_closing_date`) VALUES ('$_POST[fln]','$_POST[cld]')";

$a=mysql_query($s1,$r);

echo "<script>alert('Done');window.location='file_closing.php';</script>";
...
<ul>
   ...
   <li class='active'><a href='file_closing.php'>File Closing</a></li>
</ul>
</div>

<div id="wrapper">

<form name="file_closing" class="form" action="?file_closing" method="post">

    <div class="header">
    <center><h1>File Closing</h1></center>
    </div>
...
<td><select name="fln" class="input" required id="sel1">
  <option>SELECT</option>
					...
					mysql_select_db("nomination",$r);
							...
							$s1="SELECT * FROM project_details WHERE pro_id NOT IN(SELECT pro_id FROM file_closing) GROUP by pro_id";
 ...
 <tr>
<td align = "left">Closed Date</td>
<td><input type="date" name="cld"  class="input" size="40" placeholder="" required></td>
</tr>
</table>
