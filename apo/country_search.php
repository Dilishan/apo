...
$(function() {
    var availableTags = <?php include('autofill/autocomplete_country.php'); ?>;
    $("#tag").autocomplete({
...
<form name="pro_search" class="form" action="country_wise.php" method="post">

	 <div class="header">
    <center><h1>Enter a Name of a Country</h1></center>
    </div>
	...
	<table>
	<tr>
	<td><div class="sbox"><input type="text" class="input" name="cnt" id="tag" size="40" required></div></td>
	</tr>
	</table>
