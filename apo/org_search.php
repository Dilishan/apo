...
$(function() {
    var availableTags = <?php include('autofill/autocomplete_cname.php'); ?>;
    $("#tag").autocomplete({
...
<form name="org_search" class="form" action="org_wise.php" method="post">

	 <div class="header">
    <center><h1>Enter a Name of an Organization</h1></center>
    </div>
	...
	<table>
	<tr>
	<td><div class="sbox"><input type="text" class="input" name="orgs" id="tag" size="40" required></div></td>
	</tr>
	</table>
